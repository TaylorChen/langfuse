...
export function ApiKeyList(props: { entityId: string; scope: ApiKeyScope }) {
  ...
  const scopeLabel =
    scope === "project"
      ? t("apiKeys.projectScope")
      : t("apiKeys.organizationScope");
    ...
    return (
      <div>
        ...
        <Alert>
          ...
          <AlertDescription>
            {t("apiKeys.accessDeniedDescription", { scope: scopeLabel })}
          </AlertDescription>
        </Alert>
      </div>
    );
  ...
  return (
    <div className="space-y-4">
      <Header
        title={t("apiKeys.scopedTitle", { scope: scopeLabel })}
        help={{
          description: t("apiKeys.learnMore", { scope: scopeLabel }),
          href:
            scope === "project"
      ...
      <CodeView
        content={envCode}
        title=".env"
        copiedToClipboardMessage={t("apiKeys.secretsNotIncluded")}
      />
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            {t("apiKeys.deleteApiKeyDescription")}
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
          <Button
