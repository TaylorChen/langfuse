...
const DemoBadge = () => {
  ...
  return (
    <SidebarGroup className="border-b">
      <SidebarGroupLabel>{t("navigation.demoProject")}</SidebarGroupLabel>
      <SidebarGroupContent>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              tooltip={t("navigation.useDemoAppTooltip")}
              variant="cta"
            >
              <Link
              ...
              >
                ...
                <span>{t("navigation.useDemoApp")}</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              tooltip={t("navigation.yourLangfuseOrgsTooltip")}
            >
              <Link href="/">
                <Grid2X2 className="h-4 w-4" />
                <span>{t("navigation.yourLangfuseOrgs")}</span>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
