...
export default function PosthogIntegrationSettings() {
  ...
  return (
    <ContainerPage
      headerProps={{
        title: t("analyticsIntegrations.posthogTitle"),
        breadcrumb: [
          {
    ...
    >
      <p className="text-primary mb-4 text-sm">
        {t("analyticsIntegrations.posthogIntroPrefix")}{" "}
        <Link href="https://posthog.com" className="underline">
          PostHog
        </Link>{" "}
        {t("analyticsIntegrations.posthogIntroSuffix")}
      </p>
      {!hasAccess && (
    ...
    <Form {...posthogForm}>
      <form className="space-y-3" onSubmit={posthogForm.handleSubmit(onSubmit)}>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                {t("analyticsIntegrations.posthogHostname")}
              </FormLabel>
              <FormControl>
                <Input {...field} />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                {t("analyticsIntegrations.posthogProjectApiKey")}
              </FormLabel>
              <FormControl>
                <PasswordInput {...field} />
              </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  {t("analyticsIntegrations.posthogExportSourceDescription")}
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
      ...
      <div className="mt-8 flex gap-2">
        ...
        <Button
          ...
          onClick={() => {
            if (confirm(t("analyticsIntegrations.resetPosthogConfirm")))
