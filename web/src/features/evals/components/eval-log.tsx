...
export default function EvalLogTable({
  ...
  const columns = [
    ...
    columnHelper.accessor("scoreName", {
      header: translateText("Score Name"),
      id: "scoreName",
      enableHiding: true,
    }),
    columnHelper.accessor("scoreValue", {
      header: translateText("Score Value"),
      id: "scoreValue",
      enableHiding: true,
      cell: (row) => {
    ...
    columnHelper.accessor("scoreComment", {
      header: translateText("Score Comment"),
      id: "scoreComment",
      enableHiding: true,
      cellPadding: "none",
      loadingCell: () => (
    ...
    columnHelper.accessor("traceId", {
      id: "traceId",
      header: translateText("Target Trace"),
      cell: (row) => {
  ...
  if (!jobConfigurationId) {
    columns.push(
      columnHelper.accessor("evaluatorId", {
        id: "evaluatorId",
        header: translateText("Evaluator"),
        cell: (row) => {
