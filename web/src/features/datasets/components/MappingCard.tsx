              ...
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[250px]" side="left">
                    {useDirectMappingForInput
                      ? t("datasets.mapColumnsDirectInput")
                      : t("datasets.mapColumnsToSchema")}
                  </TooltipContent>
                </Tooltip>
              </div>
            )}
              ...
              expectedOutputSchemaKeys.length > 0 && (
                <div className="flex items-center gap-1.5">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-[250px]" side="left">
                      {useDirectMappingForExpectedOutput
                        ? t("datasets.mapColumnsDirectExpectedOutput")
                        : t("datasets.mapColumnsToSchema")}
                    </TooltipContent>
                  </Tooltip>
                </div>
