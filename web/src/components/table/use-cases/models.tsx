...
export default function ModelTable({ projectId }: { projectId: string }) {
  ...
  const columns: LangfuseColumnDef<ModelTableRow>[] = [
      ...
      header: () => {
        return (
          <div className="flex items-center gap-2">
            <span>
              {t("models.prices")} {priceUnitLabel}
            </span>
            <PriceUnitSelector />
          </div>
        );
    ...
    },
    {
      ...
      headerTooltip: {
        description: t("models.tokenizerDescription"),
      },
      enableHiding: true,
      size: 120,
    },
    {
      accessorKey: "config",
      id: "config",
      header: t("models.tokenizerConfiguration"),
      headerTooltip: {
        description: t("models.tokenizerConfigDescription"),
      },
      enableHiding: true,
      size: 120,
      cell: ({ row }) => {
