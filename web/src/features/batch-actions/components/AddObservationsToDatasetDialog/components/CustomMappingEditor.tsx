...
export function CustomMappingEditor({
  ...
  return (
    <div className="bg-muted/30 space-y-2 rounded-md border p-4">
      <div>
        <Label className="text-sm font-medium">{t("common.target")}</Label>
        <Tabs
          value={config.type}
        ...
        >
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="root">{t("common.root")}</TabsTrigger>
      ...
      {config.type === "root" && (
        <div className="space-y-4">
          <div>
            <Label className="text-sm font-medium">{t("common.source")}</Label>
            <div className="mt-1">
              <SourceFieldSelector
          ...
          <div>
            ...
            <p className="text-muted-foreground p-1 text-xs">
              {t("batchActions.jsonPathStartHint")}
            </p>
          </div>
        </div>
      )}
  ...
  return (
    ...
    >
          ...
          <Button
            ...
            title={
              isSchemaField && isRequired
                ? t("batchActions.requiredSchemaFieldCannotBeRemoved")
      ...
      <div className="grid grid-cols-[38fr_62fr] gap-2">
        ...
        <div>
          <Label className="text-muted-foreground text-xs">
            {t("common.value")} {!isPath && t("batchActions.literalSuffix")}
          </Label>
          <div className="mt-1">
            {isPath ? (
              <JsonPathInput
