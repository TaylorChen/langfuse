            ...
            <Card className="flex flex-1 flex-col">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
                  ...
                  {translateText("via User Interface")}
                </CardTitle>
                <CardDescription>
                  {translateText(
              ...
              <CardContent>
                <ul className="text-muted-foreground list-disc space-y-2 pl-4 text-sm">
                  <li>{translateText("Compare prompt versions")}</li>
                  <li>{translateText("Compare model configurations")}</li>
                  <li>{translateText("No code required")}</li>
                </ul>
              </CardContent>
            ...
            <Card className="flex flex-1 flex-col">
              ...
              <CardContent>
                <ul className="text-muted-foreground list-disc space-y-2 pl-4 text-sm">
                  ...
                  <li>
                    {translateText("Keep experiment results in Langfuse")}
                  </li>
                </ul>
                {!fixedDatasetId ? (
              ...
              <CardFooter className="mt-auto flex flex-row gap-2">
                {hasRemoteExperiment && !isRemoteExperimentLoading ? (
                  <div className="flex w-full items-start">
                    <Button
                      ...
                      title={
                        isRemoteExperimentEnabled
                          ? undefined
                          : translateText("please edit and enable webhook")
                      }
                      onClick={() => {
                    ...
                    <Button
                      aria-label={translateText("Edit remote trigger settings")}
                      className="rounded-l-none rounded-r-md border-l-2 px-2"
                      title={translateText("Edit remote trigger settings")}
