...
export const CreateOrEditAnnotationQueueButton = ({
  ...
  useUniqueNameValidation({
    ...
    form,
    errorMessage: t("annotationQueues.queueNameAlreadyExists"),
  });
  ...
  const handleOnValueChange = (values: Record<string, string>[]) => {
    ...
    if (values.length === 0) {
      form.setError("scoreConfigIds", {
        type: "manual",
        message: t("annotationQueues.scoreConfigRequired"),
      });
    } else {
              ...
              <DialogBody>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("annotationQueues.scoreConfigs")}
                      </FormLabel>
                      <FormDescription>
                      ...
                      <FormControl>
                        <MultiSelectKeyValues
                          ...
                          controlButtons={
                            ...
                            >
                              {t("annotationQueues.manageScoreConfigs")}
                            </DropdownMenuItem>
                          }
                        />
                      </FormControl>
