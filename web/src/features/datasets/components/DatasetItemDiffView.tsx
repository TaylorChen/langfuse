    ...
    <div className="space-y-4">
      ...
      >
        <AccordionItem value="input">
          <AccordionTrigger>{t("common.input")}</AccordionTrigger>
          <AccordionContent>
            <DiffViewer
        ...
        <AccordionItem value="output">
          <AccordionTrigger>{t("common.expectedOutput")}</AccordionTrigger>
          <AccordionContent>
            <DiffViewer
        ...
        <AccordionItem value="metadata">
          <AccordionTrigger>{t("common.metadata")}</AccordionTrigger>
          <AccordionContent>
            <DiffViewer
