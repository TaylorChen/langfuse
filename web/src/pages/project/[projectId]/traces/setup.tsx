...
export const TracingSetup = ({
  ...
  return (
    <div className="space-y-8">
      <div>
        <SubHeader title={translateText("1. Get API keys")} />
        {apiKeys ? (
          <ApiKeyRender
      ...
      <div>
        <SubHeader
          title={translateText("2. Add tracing to your application")}
        ...
        <ActionButton href="https://langfuse.com/docs/observability/get-started">
          {translateText("Quickstart guide")}
        </ActionButton>
      </div>
    </div>
  );
...
export default function TracesSetupPage() {
  ...
  return (
    <ContainerPage
      headerProps={{
        title: translateText("Tracing Setup"),
        help: {
