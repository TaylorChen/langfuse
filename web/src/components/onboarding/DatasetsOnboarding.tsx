...
export function DatasetsOnboarding({ projectId }: { projectId: string }) {
  ...
  const valuePropositions: ValueProposition[] = [
    {
      title: translateText("Continuous improvement"),
    ...
    {
      title: translateText("Pre-deployment testing"),
      description: translateText(
    ...
    {
      title: translateText("Structured testing"),
      description: translateText(
    ...
    {
      title: translateText("Custom workflows"),
      description: translateText(
  ...
  return (
    <SplashScreen
      title={translateText("Get Started with Datasets & Experiments")}
      description={translateText(
      ...
      primaryAction={{
        label: translateText("Create Dataset"),
        component: (
          <DatasetActionButton
            variant="default"
            mode="create"
