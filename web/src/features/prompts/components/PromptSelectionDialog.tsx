  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>{t("prompts.addInlinePromptReference")}</DialogTitle>
        </DialogHeader>
        <DialogBody>
          <div className="flex flex-col gap-4">
            <p className="text-muted-foreground text-sm">
              {t("prompts.inlineReferenceDescription")}
            </p>

            <div className="flex flex-col gap-2">
              <Label htmlFor="prompt-name">{t("prompts.promptName")}</Label>
              <Select
              ...
              >
                <SelectTrigger id="prompt-name">
                  <SelectValue placeholder={t("prompts.selectTextPrompt")} />
                </SelectTrigger>
                <SelectContent>
              ...
              <p className="text-muted-foreground text-xs">
                {t("prompts.onlyTextPromptsInline")}
              </p>
            </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  <SelectTrigger id="selection-type">
                    <SelectValue placeholder={t("prompts.selectLinkType")} />
                  </SelectTrigger>
                  <SelectContent>
                  ...
                  >
                    <SelectTrigger id="version-or-label">
                      <SelectValue
                        placeholder={
                          selectionType === "version"
                            ? t("prompts.selectVersion")
                            : t("prompts.selectLabel")
                        }
                      />
                    </SelectTrigger>
                    <SelectContent>
          ...
          {selectedTag && (
            <div className="space-y-2">
              <Label>{t("prompts.tagPreview")}</Label>
              ...
              <p className="text-muted-foreground text-xs">
                {onSelect ? t("prompts.tagInserted") : t("prompts.tagCopied")}
              </p>
            </div>
          )}
        </DialogBody>
