      ...
      <DropdownMenuTrigger asChild>
        <Button variant="outline">
          ...
          <span className="ml-2 hidden md:inline">
            {translateText("Display")}
          </span>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-56">
        <DropdownMenuLabel>{translateText("Layout")}</DropdownMenuLabel>
        ...
        >
          ...
          {translateText("Show only items in baseline")}
        </DropdownMenuItem>
        <DropdownMenuItem
