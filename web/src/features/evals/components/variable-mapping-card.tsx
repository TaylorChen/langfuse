    ...
    <Card className="max-w-full min-w-0 p-4">
      <div className="mb-2 flex items-center gap-2">
        <span className="text-lg font-medium">
          {translateText("Variable mapping")}
        </span>
            ...
            <>
              ...
              >
                {showPreview ? (
                    ...
                    <div className="bg-muted/50 flex max-h-full min-h-48 w-full flex-col gap-1 lg:w-2/3">
                      <div className="flex flex-row items-center justify-between py-0 text-sm font-medium capitalize">
                        <div className="flex flex-row items-center gap-2">
                          {translateText("Evaluation Prompt Preview")}
                  ...
                  <JSONView
                    title={translateText("Evaluation Prompt")}
                  ...
                  {disabled && !syncStatus.inSync && (
                    <Alert className="text-sm" variant="destructive">
                      ...
                      <AlertTitle className="text-base">
                        {translateText("Variable mapping is out of sync")}
                      </AlertTitle>
                      <AlertDescription>
                        {translateText(
                          "The template has {added} new variable(s) and {removed} removed variable(s). Toggle Edit Mode to update the mapping.",
                        )
                          .replace("{added}", String(syncStatus.added.length))
                          .replace(
                            "{removed}",
                            String(syncStatus.removed.length),
                          )}
                      </AlertDescription>
                    </Alert>
                  )}
                        ...
                        <Card className="flex flex-col gap-2 p-4" key={index}>
                            ...
                            <FormField
                              ...
                              render={({ field }) => {
                                ...
                                return (
                                  <div className="flex items-center gap-2">
                                    <VariableMappingDescription
                                      title={translateText("Object Name")}
                                      description={translateText(
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <div className="flex items-center gap-2">
                                <VariableMappingDescription
                                  title={translateText("Object Field")}
                                  description={translateText(
                                  ...
                                  <FormItem className="w-2/3">
                                    <FormControl>
                                      <Input
                                        ...
                                        value={field.value ?? ""}
                                        disabled={disabled}
                                        placeholder={translateText("Optional")}
                                      />
                                    </FormControl>
                                    <FormMessage />
                                  </FormItem>
                                ...
                                <Input
                                  value={
                                    isEventTarget(form.watch("target"))
                                      ? translateText("Observation")
                                      : translateText("Experiment item")
                                  }
                                  disabled
                                />
                              </div>
