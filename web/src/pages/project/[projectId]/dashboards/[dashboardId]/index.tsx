...
export default function DashboardDetail() {
  ...
  const updateDashboardDefinition =
    api.dashboard.updateDashboardDefinition.useMutation({
      ...
      onError: (error) => {
        showErrorToast(t("dashboard.updateError"), error.message);
      },
    });
  ...
  const updateDashboardFilters =
    api.dashboard.updateDashboardFilters.useMutation({
      ...
      onError: (error) => {
        showErrorToast(t("dashboard.filtersSaveError"), error.message);
      },
    });
  ...
  const filterColumns: ColumnDefinition[] = [
    {
      name: translateText("Environment"),
      id: "environment",
      type: "stringOptions",
    ...
    {
      name: translateText("Observation Name"),
      id: "observationName",
      type: "string",
      internal: "internalValue",
    },
    {
      name: translateText("Score Name"),
      id: "scoreName",
      type: "string",
      internal: "internalValue",
    },
    {
      name: translateText("Tags"),
      id: "tags",
      type: "arrayOptions",
      options: tagsOptions,
      internal: "internalValue",
    ...
    {
      name: translateText("User"),
      id: "user",
      type: "string",
      internal: "internalValue",
    },
    {
      name: translateText("Session"),
      id: "session",
      type: "string",
      internal: "internalValue",
    },
    {
      name: translateText("Metadata"),
      id: "metadata",
      type: "stringObject",
      internal: "internalValue",
    },
    {
      name: translateText("Release"),
      id: "release",
      type: "string",
      internal: "internalValue",
    },
    {
      name: translateText("Version"),
      id: "version",
      type: "string",
      internal: "internalValue",
    },
  ...
  const mutateCloneDashboard = api.dashboard.cloneDashboard.useMutation({
    ...
    onError: (e) => {
      showErrorToast(t("dashboard.cloneError"), e.message);
    },
  });
  ...
  return (
    ...
    >
      <Page
        ...
        headerProps={{
          title:
            (dashboard.data?.name || translateText("Dashboard")) +
            (dashboard.data?.owner === "LANGFUSE"
              ? ` (${t("dashboard.maintainedSuffix")})`
              : ""),
          breadcrumb: [
            {
              name: translateText("Dashboards"),
