        ...
        <PopoverTrigger asChild>
          {buttonType === "default" ? (
            <Button variant="outline" type="button">
              <span>{translateText("Filters")}</span>
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            {!organization?.aiFeaturesEnabled ? (
              ...
              translateText("Create Filter with AI")
            )}
          </Button>
          {showAiFilter && (
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {createFilterMutation.isPending
                    ...
                    : translateText("Generate filters")}
                </Button>
                <Tooltip>
                  <TooltipTrigger asChild>
                ...
                return (
                  <tr key={i}>
                    <td className="p-1 text-sm">
                      {i === 0 ? translateText("Where") : translateText("And")}
                    </td>
                    <td className="flex gap-2 p-1">
                      ...
                      <Popover>
                        ...
                        >
                          <InputCommand>
                            <InputCommandInput
                              placeholder={translateText("Search for column")}
                              variant="bottom"
                            />
                            <InputCommandList>
                              <InputCommandEmpty>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="nthFromStart">
                              {translateText("nth from start")}
                            </SelectItem>
                            <SelectItem value="nthFromEnd">
                              {translateText("nth from end")}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      ) : null}
                    ...
                    <td className="p-1">
                      ...
                      filter.type === "stringObject" ? (
                        <Input
                          disabled={disabled}
                          value={filter.value ?? ""}
                          placeholder={translateText("string")}
                          onChange={(e) =>
                            handleFilterChange(
                        ...
                        <Input
                          ...
                          placeholder={translateText("number")}
                          lang="en-US"
                          onChange={(e) =>
                            handleFilterChange(
                              {
