    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent size="lg" className="min-h-[62vh] overflow-y-auto">
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col">
          <DialogHeader>
            <DialogTitle>{t("models.testModelMatch")}</DialogTitle>
            <DialogDescription className="mt-1">
              {t("models.testModelMatchDescription")}
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="text-sm font-medium">
                    {t("models.modelNameRequired")}
                  </div>
                  <div className="text-muted-foreground text-sm">
                    {t("models.modelNameOnGenerations")}
                  </div>
                  <Input
                  ...
                  <>
                    {isLoading && (
                      <div className="bg-muted/30 text-muted-foreground flex min-h-[300px] items-center justify-center gap-2 rounded-lg border p-6">
                        <Spinner size="md" />
                        <span>{t("models.testingMatch")}</span>
                      </div>
                    )}
